...
export default function AISuggestionsPage() {
  ...
  async function onApprove() {
    ...
    setError(null);
    try {
      const updated = await approveSuggestion(selected.id);
  ...
  async function onReject() {
    ...
    setError(null);
    try {
      const updated = await rejectSuggestion(selected.id);
  ...
  async function onConvert() {
    ...
    setError(null);
    try {
      const result = await convertSuggestionToCatalog(selected.id);
      setMessage(
          ...
          {!selected ? (
            ...
            <>
              ...
              <div className="safety-note">
                ...
                <code>enable: false</code>. Do not treat generated_playbook as
                runnable.
              </div>
              ...
              <div className="btn-row">
                ...
                <button
                  ...
                  title="Creates disabled catalog entry only"
                >
